...
const Herosec = () => {
  return (
    <div className=' w-screen bg-white mb-[10px] '>
         <div className=' w-full sm:w-[80vw]   min-h-[300px] gap-[8px]  flex lg:flex-row flex-col justify-between items-center mt-2 max-w-[1600px] mx-auto'>
            < div className='flex min-h-[300px] h-[300px] w-full lg:w-[70%]  rounded-xl gap-1 bg-slate-300'>
            ...
            <div className="rounded-xl w-[50%] lg:w-full lg:h-[50%] flex bg-slate-300">
                <div className="w-[50%] flex flex-col mt-[20px] items-center">
                    ...
                    <h1 className='text-xl ml-2'>Intelligent <br></br>& Durable <br></br>Design</h1>
                 </div>
            ...
            <div className="w-[50%] flex flex-col mt-[20px] items-center ">
                    <h1 className='text-blue-400'>COMPUTERS</h1>
                    <h1 className='text-xl ml-2'>Build your <br></br>& Durable <br></br>Design</h1>
