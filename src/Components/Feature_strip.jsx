            ...
            <div className='w-screen  bg-gray-500 '>
                  <div className='flex flex-wrap  px-5 sm:px-auto  sm: text-white min-h-[75px] mx-auto flex justify-between items-center max-w-[1600px]'>
                        <div className="flex gap-[10px] my-2">
                              <div className="h-[40px] w-[40px] border text-blue-600 rounded-4xl flex justify-center items-center"> <div className='text-amber-950 text-2xl'><FaVanShuttle /></div>
                              </div>
                        ...
                        <div className="flex gap-[10px] my-2">
                              <div className="h-[40px] w-[40px] border text-blue-600 rounded-4xl flex justify-center items-center"> <div className='text-amber-950 text-4xl'><IoReturnUpBack /></div>
                              </div>
                        ...
                        <div className="flex gap-[10px] my-2">
                              <div className="h-[40px] w-[40px] border text-blue-600 rounded-4xl flex justify-center items-center"> <div className='text-amber-950 text-3xl'><GrSecure />
                              </div>
                              </div>
