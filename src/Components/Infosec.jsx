  ...
  return (
    <div className='hidden sm:block w-screen   bg-blue-500 '>
         <div className=' text-white min-h-[45px] mx-auto flex justify-between items-center  max-w-[1600px]'>
           ...
           <div className='flex gap-1 items-center text-black px-2 lg:px-auto '><FaBars />ALL DEPARTMENT</div> </div>
           <div>MULTILEVEL</div>
           <div>MEGA MENU</div>
           <div>FULLWIDTH</div>
            </ol>
             <ol className='flex justify-center gap-5 text-[15px] items-center'>
                ...
                <div className='min h-[45px]  bg-amber-400 flex items-center'>
                <div className='flex gap-1 justify-center items-center text-black w-[65px] px-2 lg:px-auto'><FaMessage />Blog
                </div>
                </div>
             </ol>
